...
public class ListBlockParser extends AbstractBlockParser {
    ...
    private static ListData parseList(CharSequence line, final int markerIndex, final int markerColumn,
        ...
        if(!Parsing.IS_ROUNDTRIP) {
            ...
            // AST: Even empty lines should be captured
            ...
            switch (c) {
                ...
                case ')':
                    if (digits >= 1 && isSpaceTabOrEnd(line, i + 1)) {
                        ...
                        if(Parsing.IS_ROUNDTRIP) {
                            // AST: Capture actual number from the text,
                            //      as repeatedly entering <pre>1.</pre>
                            //      is valid input and only in the
                            //      rendering does this get auto-incremented
    ...
    public static class Factory extends AbstractBlockParserFactory {
        ...
        public BlockStart tryStart(ParserState state, MatchedBlockParser matchedBlockParser) {
            ...
            if(Parsing.IS_ROUNDTRIP) {
                // AST: Capture whitespace before delimiter
